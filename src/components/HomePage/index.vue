<template>
  <div class="homepage">
    <div class="word-container text">
      <span class="letter" v-for="(letter, index) in letters" :key="index" @click="flyFn(letter.val)" :class="{ alive: letter.alive }">
  ...
  methods: {
    flyFn (val) {
      this.letters = this.letters.map(item => {
        if (item.val === val) item.alive = !item.alive
        return item
      })
    }
  }
...
@-webkit-keyframes poofing1 {
  ...
  100% {
    -webkit-transform: rotateZ(459deg) rotateY(360deg) translateY(-500px) scale(0.01);
            transform: rotateZ(459deg) rotateY(360deg) translateY(-500px) scale(0.01);
  }
}
@keyframes poofing1 {
  0% {
...
@-webkit-keyframes poofing2 {
  ...
  100% {
    -webkit-transform: rotateZ(540deg) rotateY(360deg) translateY(-500px) scale(0.01);
            transform: rotateZ(540deg) rotateY(360deg) translateY(-500px) scale(0.01);
  }
}
@keyframes poofing2 {
  0% {
...
@-webkit-keyframes poofing3 {
  ...
  100% {
    -webkit-transform: rotateZ(264deg) rotateY(360deg) translateY(-500px) scale(0.01);
            transform: rotateZ(264deg) rotateY(360deg) translateY(-500px) scale(0.01);
  }
}
@keyframes poofing3 {
  0% {
...
@-webkit-keyframes poofing4 {
  ...
  100% {
    -webkit-transform: rotateZ(42deg) rotateY(360deg) translateY(-500px) scale(0.01);
            transform: rotateZ(42deg) rotateY(360deg) translateY(-500px) scale(0.01);
  }
}
@keyframes poofing4 {
  0% {
...
@-webkit-keyframes poofing5 {
  ...
  100% {
    -webkit-transform: rotateZ(384deg) rotateY(360deg) translateY(-500px) scale(0.01);
            transform: rotateZ(384deg) rotateY(360deg) translateY(-500px) scale(0.01);
  }
}
@keyframes poofing5 {
  0% {
